...
function ListArtwork(artwork) {
    return `<tr>
                ...
                <td>
                <button onclick="approve('${artwork.filepath}')">Approve</button>
                <button onclick="deny('${artwork.filepath}')">Deny</button></td>
            </tr>`;
}
...
function getArtworks() {
    let xhr = new XMLHttpRequest();
    xhr.open('get', 'http://localhost:8080/project1/api/artwork/getunapproved');
    xhr.onload = function () {
